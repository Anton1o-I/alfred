...
INTENT_PROMPT = (
    ...
    "- list: user wants to see what's pending/overdue/outstanding\n"
    ...
    "\n"
    "LIST phrasings — any question that asks what's pending, outstanding, "
    "overdue, owed, or 'on the list' is action='list'. Examples:\n"
    "  • 'what chores do I have' → list\n"
    "  • 'list my chores' → list\n"
    "  • \"what's pending?\" → list\n"
    "  • \"what's outstanding right now?\" → list\n"
    "  • 'remind me what's outstanding' → list\n"
    "  • \"what's overdue?\" → list\n"
    "  • 'show me the chore list' → list\n"
    "  • 'what does Alex owe?' → list (scoped to Alex)\n"
    "  • \"show me Alex's chores\" → list (scoped to Alex)\n"
    "  • 'what does my spouse have pending' → list (scoped to spouse)\n"
    "  • 'what household chores are open' → list (scoped to household)\n"
    "\n"
    "When the action is 'list' AND the user scoped it to a person or to "
    "'household', set list_target.reference to that exact phrase. Otherwise "
    "leave list_target null. Do NOT set list_target for non-list actions.\n"
    "\n"
    "Email body:\n"
    "{email_body}"
)
